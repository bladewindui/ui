...
- [x] **Confirm / alert dialog** (`bladewind-confirm-dialog`, Content) — Purpose-built confirmation modal for destructive or consequential actions, with async pending state and cancel/confirm actions, distinct from the generic Modal.
