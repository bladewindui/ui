[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/bladewindui/statistic)](https://packagist.org/packages/bladewindui/statistic)

<img src="https://bladewindui.com/assets/images/bw-logo.png" height="30" alt="BladewindUI" />

# Statistic / KPI Card

BladewindUI — Statistic / KPI card component.

## Installation

```bash
composer require bladewindui/statistic
```
