[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/bladewindui/textarea)](https://packagist.org/packages/bladewindui/textarea)
...
```bash
composer require bladewindui/textarea
```
