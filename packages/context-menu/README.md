[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/bladewindui/context-menu)](https://packagist.org/packages/bladewindui/context-menu)
...
```bash
composer require bladewindui/context-menu
```
