[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/bladewindui/carousel)](https://packagist.org/packages/bladewindui/carousel)
...
```bash
composer require bladewindui/carousel
```
