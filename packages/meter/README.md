[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/bladewindui/meter)](https://packagist.org/packages/bladewindui/meter)
...
```bash
composer require bladewindui/meter
```
